export default class Fish {
    constructor(fishMesh, id, scaling, scene) {
        ...
        // scaling
        this.fishMesh.scaling = new BABYLON.Vector3(scaling, scaling, scaling);
        ...
        if (Fish.boundingBoxParameters == undefined) {
            Fish.boundingBoxParameters = this.calculateBoundingBoxParameters();
        }

        this.bounder = this.createBoundingBox();
        this.bounder.fishMesh = this.fishMesh;
    }
    ...
    calculateBoundingBoxParameters() {
        ...
        let childrenMeshes = this.fishMesh.getChildren();
    ...
    createBoundingBox() {
        // Create a box as BoundingBox of the Fish
        ...
        bounder.position = this.fishMesh.position.clone();
